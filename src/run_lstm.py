...
if __name__=='__main__':
    ...
    epochs  = 50  # suggest 100 for sine wave, 10 for stock
    seq_len = 24 # suggest using 25 for sine wave, 50 for stock
    ...
    # stock data
    X_train, y_train, X_test, y_test = lstm.load_data('data/hours_df.pkl', seq_len, True) # data is a stock, normalize data is True

    print('> Data Loaded. Compiling...')

    model = lstm.build_model([1, seq_len, 1000, 1]) # 1 input layer, layer 1 has seq_len neurons, layer 2 has 100 neurons, 1 output
